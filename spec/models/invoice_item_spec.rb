...
RSpec.describe InvoiceItem, type: :model do
  ...
  describe "methods" do 
      ...
      @invoice_4 = Invoice.create!(merchant_id: @merchant1.id, customer_id: @customer_5.id, status: 1)
    ...
    it "knows incomplete invoices" do
      expected = [@invoice_1, @invoice_2, @invoice_4, @invoice_5]

      expect(InvoiceItem.incomplete_invoices).to eq(expected)
    end
  end 
end
